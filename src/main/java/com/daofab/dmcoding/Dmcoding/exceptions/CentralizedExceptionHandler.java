package com.daofab.dmcoding.Dmcoding.exceptions;
...
public class CentralizedExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleLoanException(HttpClientErrorException ex, WebRequest request) {
        String error = ex.getMessage();
        ApiError apiError = new ApiError(false, 500, ex.getMessage(), error);
